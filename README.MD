...
options:
  ...
  -S SORT, --sort SORT  Sorting: size-, size+, name-, name+ (default name+). Applies to stdout and markdown.
...
```bash
$ linkermap --sort=size- cdc_msc.elf.map
...
```
$ linkermap -sort=size- -v cdc_msc.elf.map
                                              File |   .text   .data    .bss   Total
------------------------------------------------------------------------------------
                                    usbd_control.o |       0      84     516     600
                                    -------------- |--------------------------------
